...
$config['ads_url'] = $config['up_url'].'ads/';  //广告文件上传位置
$config['approve_url'] = $config['up_url'].'approve/'; //身份证图片文件上传位置
$config['cases_url'] = $config['up_url'].'cases/';  //案例图片文件上传位置
$config['certificate_url'] = $config['up_url'].'certificate/';  //证书图片文件上传位置
$config['retrieval_url'] = $config['up_url'].'retrieval/';  //投标图片文件上传位置
...
//$config['jsfiles'][] = 'js/mod_poshytip.js';
#Png透明
$config['jsfiles'][] = 'js/png24.js';
//#flash
//$config['jsfiles'][] = 'js/swfobject_modified.js';
#获取最新消息
...
$config['YeePay_Id']  = "10011204711";																									
#密钥
$config['YeePay_Key'] = "65n378k878UI1YN3K91s5U1614iVok6H47Cb38ku99E8405773S20aI373X6";
#日志文件
$config['YeePay_Log'] = "YeePay_HTML.log";
# 业务类型: 支付请求，固定值"Buy" .	
$config['YeePay_Cmd'] = "Buy";
# 送货地址
# 为"1": 需要用户将送货地址留在易宝支付系统;为"0": 不需要，默认为 "0
$config['YeePay_Saf'] = "0";

#<>测试帐号<><><><><><><><><><><><><><><><>
#$config['YeePay_Id']  = "10001126856";																									
#$config['YeePay_Key'] = "69cl522AV6q613Ii4W6u8K6XuW8vM1N6bFgyv769220IuYe9u37N4y7rI4Pl";
...
|
*/
$config['sess_cookie_name']		= 'tg_sess_0x11292011';
$config['sess_expiration']		= 7200;
$config['sess_expire_on_close']	= FALSE;
$config['sess_encrypt_cookie']	= FALSE;
$config['sess_use_database']	= FALSE;
$config['sess_table_name']		= 'tg_sess';
