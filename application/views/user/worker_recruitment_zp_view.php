...
<div class="main_width"><div class="body_main"><div class="body_left"><div class="content_box"><div class="content">
...
<div class="body_right"><div class="content_box"><div class="title"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td><h1>招聘信息</h1></td><td width="80" align="center"><a href="<?php echo site_url("user/".$view->uid)?>">查看主页</a></td></tr></table><div class="clear"></div></div><div class="content tipbox" style="padding-left:8px; padding-right:8px; width:auto; background-image:none;"><table width="100%" border="0" cellpadding="0" cellspacing="8" class="big_text"><tr><td height="40" colspan="2" align="left" style="font-size:18px; font-weight:bold;color:#333;border-bottom:#CCC 1px dotted"><?php echo $view->title?></td></tr><tr><td width="50%" align="left">发布时间：<?php echo date("m月d日 H:i",strtotime($view->addtime))?>&nbsp;</td><td width="50%" align="left">查看次数：<?php echo $view->visited?></td></tr>
<tr><td valign="top">工种：
<?php
  $inum = 0;
  $industryids = $this->Industry_Model->industrys($view->industryid);
  foreach($industryids as $gi_rs){ $inum++;
	  if($inum>1){ echo "<span>、".$gi_rs->title."</span>"; }else{ echo "<span>".$gi_rs->title."</span>"; }
  }
?>
</td><td valign="top">公司名称：<?php echo $view->c_name?></td></tr><tr><td valign="top">地址：<?php echo $view->c_addr?></td><td valign="top">工资：<?php echo $view->cost?></td></tr><tr><td valign="top">待遇：<?php echo $view->fuli?></td><td valign="top">发布人：<?php echo $this->User_Model->links($view->uid)?></td></tr><tr><td height="632" colspan="2" valign="top" style="border-top:#CCC 1px dotted; padding-top:10px;"><?php echo $view->content?></td></tr><tr><td colspan="2" align="right" valign="top">&nbsp;</td></tr></table></div></div></div><div class="clear"></div></div></div>
