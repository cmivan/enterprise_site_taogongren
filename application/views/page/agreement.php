<?php $this->load->view('public/header'); ?></head><body><?php $this->load->view('public/top'); ?>
<div class="main_width"><div class="body_main"><div class="index_left"> <div class="box">
<table border="0" align="center" cellpadding="0" cellspacing="10"><tr><td valign="top" class="page_main_title"><div>使用协议</div><p class="page_main_line">&nbsp;</p></td></tr><tr><td height="400" valign="top" class="page_main_content">
<p><strong>淘工人网服务协议（试行）</strong><br />
  ...
  <strong>若您已经注册为本网站会员，即表示您已充分阅读、理解并同意自己与本网站订立本协议，且您自愿受本协议的条款约束。本网站有权随时变更本协议并在本网站上予以公告。经修订的条款一经在本网站的公布后，立即自动生效。如您不同意相关变更，必须停止使用本网站。本协议内容包括协议正文及所有淘工人网已经发布的各类规则。所有规则为本协议不可分割的一部分，与本协议正文具有同等法律效力。一旦您继续使用本网站，则表示您已接受并自愿遵守经修订后的条款。<br />
  </strong><br />
  ...
  &ldquo;任务赏金&rdquo;:雇主在淘工人网上发起交易，确认工人身份和交易信息后，所要支付的任务费用。 </p>
</td></tr></table>
</div>
