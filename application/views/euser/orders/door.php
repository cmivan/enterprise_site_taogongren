...
<tr class="edit_item_tr"><td align="left"><?php echo $this->User_Model->links($rs->uid_2);?></td>
  ...
  <td align="center"><a href="<?php echo site_url($c_url.'orders_select').'?to_uid='.$rs->uid_2?>">下新订单</a> &nbsp;<a href="<?php echo site_url($c_urls.'/view/'.$rs->id)?>">详情</a></td></tr><tr><td colspan="9" class="yzpage_line"></td></tr>
<?php }}else{?><tr><td colspan="9" align="center">暂无上门单信息</td></tr><tr><td colspan="9" class="yzpage_line"></td></tr><?php }?></table><div class="clear"></div></div>
