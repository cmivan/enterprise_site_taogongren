...
$(function(){
	...
	$('#next_step').click(function(){
			...
			if(itemsize!=1){
				...
				window.location.href='?to_uid=' + uid;
			}
		});
	});
</script>
</head>
<body><?php $this->load->view('public/top'); ?><div class="main_width"><div class="body_main"><?php /*?>管理页面的框架分布<?php */?><div class="my_left"><div class="my_left_nav"><?php $this->load->view($c_url.'leftnav'); ?><div class="clear"></div></div></div><div class="my_right"><div class="mainbox" box="content_box"><?php /*?>订单页面操作导航<?php */?><div class="mainbox_nav"> <?php echo c_nav($thisnav,$c_url); ?> </div>
...
?>
<li><img src="<?php echo $this->User_Model->faceB($item->fuid)?>" /><br><span uid="<?php echo $item->fuid?>"><?php echo $item->name?></span></li>
<?php
  }}
?>
<div class="clear"></div>
...
<tr>
  <td valign="bottom">选择好你要下单给哪位工人，然后点击“下一步” 或 <a href="<?php echo site_url("search")?>" target="_blank" style="color:#06F;">通过搜索，有更多选择 <span style="font-family:'宋体';font-size:9px">&gt;&gt;</span></a></td>
<td><span class="cm_btu" style="display:none"><a href="javascript:void(0);" class="buttom" id="next_step">下一步</a></span></td></tr>
</table>

</td></tr></table>
<div class="clear"></div></div></div></div></div><div class="clear"></div></div></div>
