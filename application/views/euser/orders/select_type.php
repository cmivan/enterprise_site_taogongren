...
#order_select_box td a:hover b{font-size:14px;}</style>
<div class="mainbox" box="content_box"><?php /*?>订单页面操作导航<?php */?><div class="mainbox_nav"> <?php echo Get_User_Nav($thisnav,$c_url); ?> </div>
...
<a style="position:absolute; right:20px; top:5px; font-size:12px; font-weight:lighter" href="<?php echo site_url($c_urls)?>">返回选择用户</a>
第二步：请选择要下哪种订单给工人 <?php echo $this->User_Model->links($to_uid)?>
<br><span>( 温馨提示：请坚持线上交易，保障安全! )</span>
</div></td></tr>     
<tr id="order_select_box">
<td width="33%" height="200" align="center" valign="top">
<a href="<?php echo site_url($c_url.'orders_door/add/'.$to_uid)?>"><span>上门单</span><br /><b>邀请工人上门实地测量、查看，有助于工人准确了解工程，给出合理报价。<br /><span style="font-size:12px;">您可以优先选择下单给那些在特定区域免上门费的工人。</span></b></a></td><td width="33%" align="center" valign="top"><a href="<?php echo site_url($c_url.'orders_simple/add/'.$to_uid)?>"><span>简化单</span><br /><b style="text-align:left">简洁的订单流程，简短的需求描述，方便快速下单，系统自动下发短信通知，工人直接上门开工作业。<br />
<span style="font-size:12px;">请确保在下单前，与工人取得联系，双方沟通好工程的作业内容、所需费用等。</span></b></a></td>
