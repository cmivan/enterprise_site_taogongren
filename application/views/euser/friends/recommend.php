...
&nbsp;<?php echo $this->User_Model->links($rs->fuid);?></td><td>&nbsp;<?php echo $rs->note?></td><td align="center"><a href="<?php echo site_url($c_urls."/recommend")."?del_id=".$rs->id?>" class="item_del"><img src="<?php echo $img_url?>my/ico/del.gif" width="10" height="10" /></a>
&nbsp;&nbsp;<a href="javascript:void(0);" id="<?php echo $rs->fuid?>" class="recommend">修改</a></td></tr><tr><td colspan="6" class="yzpage_line"></td></tr>
