...
<?php /*?>绑定日期<?php */?><script language="javascript" type="text/javascript" src="<?php echo $js_url?>plus_cal/plus.cal.js"></script>
...
<td><div class="validform_checktip"></div></td></tr><tr><td colspan="2" class="edit_box_main"></td></tr><tr><td colspan="2">简述：<span class="edit_box_spen">这里填写工作简述</span></td></tr><tr><td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="400"><input name="note" type="text" class="inputxt" id="note" style="width:400px;" value="" maxlength="70" datatype="*5-70" nullmsg="请输入简述！"></td>
