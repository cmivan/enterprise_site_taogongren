...
<div class="mainbox_nav"><a href="javascript:void(0);" class="on">管理收藏夹</a></div>
<div class="mainbox_box">
<div class="content"><table width="100%" border="0" cellpadding="4" cellspacing="1">
...
<?php if(!empty($list)){?><?php foreach($list as $rs){?><tr class="edit_item_tr"><td align="left"><?php echo $this->User_Model->links($rs->fuid);?></td>
  <td align="center"><?php echo dateYMD($rs->addtime)?></td>
  <td align="center"><a href="<?php echo site_url($c_urls)."?del_id=".$rs->id?>" class="item_del tip" title="移出收藏夹"><img src="<?php echo $img_url?>my/ico/del.gif" width="10" height="10" /></a>
