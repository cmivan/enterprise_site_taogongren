...
<?php /*?>管理页面的框架分布<?php */?>
<div class="my_left"><div class="my_left_nav"><?php $this->load->view($c_url.'leftnav'); ?><div class="clear"></div></div></div><div class="my_right">
...
<td><a style="color:#333;" href="<?php echo $case_link?>" target="_blank"><?php echo $case_link?></a>&nbsp;&nbsp;</td>
...
<option value="<?php echo $wt_item->id?>" <?php if($wt_item->id==$info->is_team){echo 'selected';}?>> 提交到<?php echo $wt_item->title?>案例 </option>
<?php }?>
</select></td></tr>
<?php }?>
...
</td></tr><tr><td colspan="3" class="edit_box_save_but"><input type="submit" class="save_but" value="" /><input type="hidden" name="pic" value="0" /></td></tr></table></form></div></div></div><div class="clear"></div></div></div><?php $this->load->view('public/footer');?>