...
<tr class="edit_item_frist">
  ...
  <td align="center"><a href="<?php echo $rs->id?>" class="favorites_del_id"><img src="<?php echo $img_url?>my/ico/del.gif" width="10" height="10" /></a></td></tr><tr><td colspan="6" class="yzpage_line"></td></tr><?php }}else{?><tr><td colspan="6" align="center">暂无信息</td></tr>
  <?php }?></table>
