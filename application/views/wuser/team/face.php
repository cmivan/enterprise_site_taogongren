...
<form enctype="multipart/form-data" method="post" name="upform" target="upload_target" action="<?php echo site_url($c_url."up_avatar/upload")?>" style="padding-left:24px;">
...
function avatarSaved(){
	...
	<?php */?>
	window.location.href='<?php echo site_page2ajax('team/face');?>';
}
