...
<tr>
  <td align="right"><span class="cost_title">保修时间</span>：</td>
  <td align="left"><input class="inputxt" style="width:75%;" name="bx_time" type="text" id="bx_time" size="50" maxlength="40" /></td>
  <td align="left"><div class="validform_checktip">保修时间至少2个字符,最多6个字符</div></td></tr>
<tr>
...
<tr>
  ...
  <input type="submit" class="save_but" value="" /><input type="hidden" name="to_oid"  id="to_oid" value="<?php echo $to_oid?>" /></td>
  <td>&nbsp;</td></tr></table></form>
