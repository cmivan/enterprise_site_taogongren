...
&nbsp;<a href="<?php echo site_url($c_urls.'/view/'.$rs->id)?>">详情</a></td></tr><tr><td colspan="8" class="yzpage_line"></td></tr><?php }}else{?><tr><td colspan="8" align="center">暂无信息</td></tr><tr><td colspan="8" class="yzpage_line"></td></tr><?php }?></table><div class="clear"></div></div><?php $this->Paging->links(); ?><div class="clear"></div></div></div></div><div class="clear"></div></div></div>
