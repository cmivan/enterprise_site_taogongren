...
<td align="center">
<a href="<?php echo reUrl('cmd=del&id='.$rs->id)?>" class="tip item_del" title="删除该消息"><img src="<?php echo $img_url?>my/ico/del.gif" width="10" height="10" /></a>
&nbsp;
<a href="<?php echo reUrl('cmd=ok&id='.$rs->id)?>" class="tip" title="同意他的好友请求，并加他为好友！">同意加为好友</a>

<?php /*?>&nbsp;<a href="<?php echo reUrl('cmd=black&id='.$rs->id)?>" class="tip" title="把他拉到黑名单，以免骚扰！">拉黑</a><?php */?>
