...
<tr class="forumRaw">
<td width="100%" align="center" class="edit_box_edit_td"><?php echo $table_title;?> 管理列表</td><td align="right">
...
<td align="center">
  ...
  <input type="button" class="button update" url='<?php echo site_url($s_urls.'/industrys_edit')?><?php echo reUrl('id='.$rs->id)?>' value="修改"/>
</td></tr>
<?php }?>
...
<?php }else{?>
<tr class="forumRow"><td height="50" colspan="7" align="center">暂无相应内容!</td></tr>
<?php }?>
</table>
</form>
</td></tr></table>
