...
<?php /*?>用于控制投标信息页面的地区宽度<?php */?>
<style>
.retrieval_left .box li dt .city_select{width:925px;}
.city_select .citys #areas{float:right;width:812px;line-height:23px;height:auto;/*height:23px;*/}
</style>
...
<div class="retrieval_left">
<div class="box" style="border:0; background:none; padding-bottom:0px; margin-bottom:3px;">
<li><dt>
<?php /*?>城市选择<?php */?>
<div class="city_select"><div class="citys"><div id="areas" class="click_box" isfor="1" style="width:920px;">
<?php
$a_id  = $this->Place_Model->a_id;
$areas = $this->Place_Model->areas();
?>
<a href="javascript:void(0);" id="no" <?php if(is_numeric($a_id)==false){?>class="on"<?php }?>>不限</a>
<?php if(!empty($areas)):?>
<?php foreach($areas as $rs){?>
<a href="javascript:void(0);" id="<?php echo $rs->a_id?>" <?php if( $a_id == $rs->a_id ){?>class="on"<?php }?>><?php echo $rs->a_name?></a><?php }?><?php endif?></div><div class="clear"></div></div></div></dt></li><!--清除浮动--><div class="clear"></div> </div>
<div class="box"><table width="932" border="0" cellpadding="3" cellspacing="1" style="background-color:#FFE4C4" id="retrieval_box"><tr class="retrieval_title"><td width="70" class="selectbox"><div class="retrieval_select"><div class="click_box thiswidth1" id="search_usertype" isfor="1"><?php $l_onid=$this->input->getnum("usertype",'no');?><?php echo SelectListItems($team_mens,$l_onid,"全部",0)?></div></div>
<div class="title_main">投标类型<font face=Webdings>&#54;</font></div></td><td style="text-align:left;">&nbsp;标题</td><td width="45" class="selectbox"><div class="retrieval_select"><div class="click_box thiswidth2" id="classid" isfor="1"><?php $l_onid=$this->input->get("classid",true);?><?php echo SelectListItems($classids,$l_onid,"全部",0)?></div></div><div class="title_main">类别<font face=Webdings>&#54;</font></div></td><td width="145" class="selectbox" style="width:145px;"><div class="retrieval_select"><div class="click_box thiswidth3" id="search_industry" isfor="0"><?php $l_onid=$this->input->get("industry",true);?><?php echo SelectListItems($industrys,$l_onid,"",1)?>
...
<?php if(!empty($list)){?>  <?php foreach($list as $rs){?>
  <tr class="out">
    ...
    <td align="center"><?php echo $this->Retrieval_Model->industry_class_title($rs->classid)?></td>
    <td align="center" style="width:145px;"><?php echo $this->Retrieval_Model->show_industrys($rs->industryid)?></td>
