...
<?php /*?>个人信息页面操作导航<?php */?>
<div class="mainbox_nav"> <?php echo Get_User_Nav($thisnav,$c_urls); ?> </div><div class="mainbox_box"><div class="content">   <div class="diy_form" style="border:#CCC 1px solid; background-color:#FFF; margin-top:28px; margin-bottom:15px; padding-bottom:10px; padding-top:20px;"><form enctype="multipart/form-data" method="post" name="upform" target="upload_target" action="<?php echo site_url($c_url."up_avatar/upload")?>" style="padding-left:24px;"><div class="form_description">
请上传一张企业形象照片，也可以  <a style="color:#cc3300;" href="javascript:void(0);" cmd='null' onClick="useCamera()">使用摄像头!</a></div><div class="photoeditbox"><table border="0" cellpadding="0" cellspacing="3"><tr><td><input type="file" name="userfile" id="userfile" style="width:300px; padding:3px; background-color:#FFF"/></td><td><button type="submit" id="face_up_btu" onClick="return checkFile();">&nbsp;</button></td></tr><tr><td colspan="2"><span style="display:none;" id="loading_gif"><img src="<?php echo $up_url?>face/avatar_loading.gif" align="absmiddle" />上传中，请稍侯......</span></td></tr></table></div>
...
function avatarSaved(){
	alert('保存成功!');
	<?php /*?>
	PageAjax('<?php echo site_url($c_urls.'/face');?>');
	为了可以上传后刷新看效果，所以用了下面的方式
	<?php */?>
	window.location.href='<?php echo site_page2ajax('center/face');?>';
}
