...
<?php /*?>页面设置<?php */?>
<?php $this->load->view('public/public_page'); ?>
<?php /*?>验证表单<?php */?>
...
<script type="text/javascript"> $(function(){ formTO('<?php echo site_url($c_urls.'/approve_sm_save')?>',false); }); </script>

<?php /*?>倒计时<?php */?>
<script language="javascript" type="text/javascript" src="<?php echo $js_url;?>timeout.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo $js_url;?>mod-sms-send.js"></script>
<style>
.upload_img {height:135px; width:296px; margin:3px; overflow:hidden}
.upload_img img{height:135px;}
</style>
<?php /*?>
...
<link href="<?php echo $js_url?>uploadify/uploadify.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo $js_url?>uploadify/jquery.uploadify.v2.1.4.js"></script>
<script type="text/javascript" src="<?php echo $js_url?>uploadify/swfobject.js"></script>
...
<?php /*?>订单页面操作导航<?php */?>
<div class="mainbox_nav"> <?php echo c_nav($thisnav,$c_urls); ?> </div>
...
<form class="validform" method="post">
  ...
  <tr><td height="30" colspan="3" class="chenghong" style="font-size:17px;">淘工人网实名认证</td></tr>
<tr><td height="1" colspan="3" align="right" style="background-image:url(<?php echo $img_url?>ico/xline1.gif); line-height:1px;"></td></tr>
<tr><td colspan="3">
<div class="tipbox" style="line-height:200%;">
1、填写真实姓名、身份证号<br />
2、上传相关的证件(身份证正反面照片)<br />
3、实名认证后不能更改认证信息
<strong><br />您在 <span style="color:#ff0000;font-size:16px;">[ <?php echo $addtime?> ]</span> 成功提交了认证信息，请耐心等待审核！</strong>
</div></td></tr>
<tr><td width="105" align="left">真实姓名：</td><td width="210"><input name="truename" type="text" class="inputxt" id="truename" value="<?php echo $truename?>" maxlength="6" nullmsg="姓名不能为空！" errormsg="姓名至少2个字符,最多6个字符" datatype="s2-6" /></td>
  <td><div class="Validform_checktip">成功认证后,将不能修改</div></td>
</tr>
<tr><td align="left">你的身份证号：</td>
<td><input name="sfz" type="text" class="inputxt" id="sfz" value="<?php echo $sfz?>" maxlength="20" nullmsg="身份证不能为空！" errormsg="请填写正确的身份证号码！" datatype="sm"  /></td>
<td><div class="Validform_checktip">请填写你的身份证号码！</div></td>
</tr>
<tr>
  ...
  <td colspan="2"><div class="Validform_checktip">请选择身份证图片并上传！</div></td></tr>
<tr><td colspan="3" bgcolor="#eee" style="padding:5px;"><table width="100%" border="0" cellpadding="3" cellspacing="1" style=" background-color:#888">
  <tr>
    <td align="center" bgcolor="#FFFFFF">身份证（证面）</td>
    <td align="center" bgcolor="#FFFFFF">身份证（背面）</td>
    </tr>
  <tr>
    <td height="135" align="center" bgcolor="#FFFFFF"><div class="upload_img" id="upload_img_show_1"><img src="<?php echo $photo1?>" width="300" height="135"></div></td>
    <td align="center" bgcolor="#FFFFFF"><div class="upload_img" id="upload_img_show_2"><img src="<?php echo $photo2?>" width="300" height="135"></div></td>
    </tr>
  <tr>
...
<tr>
  <td colspan="3" align="center"><input id="submit_but" type="image" src="<?php echo $img_url?>submit_but.gif" style="width:82px; height:31px; border:0; padding:0; margin:0;" align="absmiddle" /></td>
</tr>
<tr>
