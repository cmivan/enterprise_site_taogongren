...
<tr><td height="30" colspan="3" class="chenghong" style="font-size:17px;">淘工人网企业认证</td></tr><tr><td height="1" colspan="3" align="right" style="background-image:url(<?php echo $img_url?>ico/xline1.gif); line-height:1px;"></td></tr><tr><td colspan="3">
</td></tr><tr>
  <td width="105" align="left">单位名称：</td><td width="210"><input name="truename" type="text" class="inputxt" id="truename" value="<?php echo $truename?>" nullmsg="单位名称不能为空！" errormsg="单位名称不能为空！" datatype="*" /></td>
  <td><div class="validform_checktip">成功认证后,将不能修改</div></td></tr><tr>
    <td align="left">营业执照号：</td><td><input name="sfz" type="text" class="inputxt" id="sfz" value="<?php echo $sfz?>" nullmsg="营业执照不能为空！" errormsg="请填写正确的营业执照号码！" datatype="*"/></td><td><div class="validform_checktip">请填写你的营业执照号码！</div></td></tr><tr>
  <td align="left">相关证件图片：
    <input name="pic1" type="hidden" id="pic1" value="<?php echo $photo1?>" nullmsg="请上传营业执照的正面图！" errormsg="请上传营业执照的正面图！" datatype="*"  >
    <input name="pic2" type="hidden" id="pic2" value="<?php echo $photo2?>" nullmsg="请上传营业执照的反面图！" errormsg="请上传营业执照的反面图！" datatype="*"  ></td>
  <td colspan="2"><div class="validform_checktip">请选择营业执照图片并上传！</div></td></tr><tr><td colspan="3" style="padding:5px; background-color:#eee;"><table width="100%" border="0" cellpadding="3" cellspacing="1" style=" background-color:#888">
  <tr>
    <td align="center" bgcolor="#FFFFFF">营业执照（正面）</td>
    <td align="center" bgcolor="#FFFFFF">营业执照（背面）</td>
    </tr>
  <tr>
...
<td valign="top" style="color:#666; line-height:180%;">确认填写的信息无误并且成功上传了营业执照的正反面图片后！请点击下面"提交"按钮，我们将在收到你提交的信息的48小时内经行审核处理！</td>
</tr></table></td></tr><tr>
  ...
  <td colspan="3" align="center">&nbsp;</td></tr></table></form>
</div></div>