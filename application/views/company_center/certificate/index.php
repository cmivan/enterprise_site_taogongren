...
<?php if(!empty($list)){?><?php foreach($list as $rs){?><tr class="edit_item_tr"><td align="center"><div style="width:150px; overflow:hidden" title="点击查看大图" class="tip" ><a href="<?php echo $uploads_url.$rs->pic?>" target="_blank"><img src="<?php echo img_certificate($rs->pic);?>" name="photo" height="20" border="0" id="photo"></a></div></td><td align="center">&nbsp;
  <?php echo $rs->title?></td><td align="center"><?php echo dateYMD($rs->addtime)?></td><td align="center"><a href="<?php echo site_url($c_urls)."?del_id=".$rs->id?>" class="item_del"><img src="<?php echo $img_url?>my/ico/del.gif" width="10" height="10" class="tip" title="删除该证书" /></a>
