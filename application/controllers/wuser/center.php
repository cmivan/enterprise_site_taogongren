...
class Center extends W_Controller {
	...
	function __construct()
	{
		...
		$this->data["thisnav"]["nav"][2]["title"] = "帐号安全";
		$this->data["thisnav"]["nav"][2]["link"]  = "security";
		$this->data["thisnav"]["nav"][3]["title"] = "修改密码";
		$this->data["thisnav"]["nav"][3]["link"]  = "reset_password";
	...
	{
		//删除赠送记录 for test!
		//$this->db->query("delete from `user_gift_ok` where uid = ".$this->logid);
		...
		/*输出到视窗*/
		$this->load->view_wuser('user/index',$this->data);
	}
	...
	function userok2gift()
	{
		...
		if($uid){ activity_userok_2gift($uid); }
	}	
