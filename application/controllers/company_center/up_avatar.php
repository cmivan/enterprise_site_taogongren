...
class Up_avatar extends COMPANY_Controller {
	...
	function __construct()
	{
		...
		//初始化用户id
		$this->logid = get_num($this->data["logid"],'404');
	...
	function upload()
	{
		...
		//}else{
			...
			//写新上传照片的ID.
			//json_echo('<script type="text/javascript">window.parent.hideLoading();window.parent.buildAvatarEditor("'.$pic_id.'","'.$pic_abs_path.'","photo");<'/script>');
		//}
