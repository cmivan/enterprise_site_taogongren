...
class Certificate extends COMPANY_Controller {
	...
	function index()
	{
		...
		/*输出到视窗*/
		$this->load->view_company('certificate/index',$this->data);
	}
	...
	function add()
	{
		...
		/*输出到视窗*/
		$this->load->view_company('certificate/add',$this->data);
	}	
	...
	function edit($id=0)
	{
		...
		/*输出到视窗*/
		$this->load->view_company('certificate/edit',$this->data);
	}
